...
const discriNegativa = ({navigation}: Props) => {
    ...
    return (
        ...
        <Text> Repetir Audio</Text>
            ...
            <Text style={mainStyles.sigueIntentando}> Sigue intentándolo</Text><Image source={require('@recursos/images/puduMalResultado.png')}
      style={loginStyles.logoPudu} />
        </GradientBackground>
    )
    
};
export default discriNegativa
